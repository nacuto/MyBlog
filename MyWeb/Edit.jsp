...
<body>
	...
	<form class="format" action="Handler1.jsp" method="post" >
		...
		<p>文章分类</p>
		<input type="radio" name="article_type" value="1" <%=belong.equals("学习")?"checked":""%> >学习
		<input type="radio" name="article_type" value="2" <%=belong.equals("随笔")?"checked":""%> >随笔
		<input type="radio" name="article_type" value="3" <%=belong.equals("科普")?"checked":""%> >科普
		<input type="radio" name="article_type" value="4" <%=belong.equals("美食")?"checked":""%> >美食
		<p>文章标题</p>
		<div>
